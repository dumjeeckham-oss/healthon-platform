          ...
          actions: [
            ...
            FilledButton(
              onPressed: () async {
                ...
                try {
                  await repo.createCorporateNews(CorporateNews(
                    id: '',
                  ...
                  if (mounted) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('법인소식이 작성되었습니다')),
                    );
                  }
                } catch (e) {
                  if (ctx.mounted) {
                    ScaffoldMessenger.of(ctx).showSnackBar(
                      SnackBar(content: Text('작성 실패: $e'), backgroundColor: Colors.red[700]),
                    );
                  }
                }
              },
