-- ================================================================
-- HealthON Phase 6 — Family 고도화 Migration
-- ================================================================
...
-- ================================================================
-- 4. family_challenge_participation — 가족 챌린지 참여
-- ================================================================
...
BEGIN
  ...
  SELECT
    ...
    COALESCE(CAST(u.raw_user_meta_data->>'tree_level' AS INTEGER), 1),
    COALESCE(CAST(u.raw_user_meta_data->>'streak' AS INTEGER), 0)
